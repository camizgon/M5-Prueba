...
var _TiposDeAnimales = require("./Dominio/TiposDeAnimales.js");
...
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; } // Punto 5: Dividir el código en módulos
...
(function () {
  ...
  document.getElementById("btnRegistrar").addEventListener("click", function () {
    ...
    switch (nombre) {
      case "Leon":
        ...
        animal = new _TiposDeAnimales.Leon(nombre, edad, imgPath, comentarios, sonido);
        // sale del bloque
        break;
      case "Lobo":
        imgPath = "./assets/imgs/Lobo.jpg";
        animal = new _TiposDeAnimales.Lobo(nombre, edad, imgPath, comentarios, sonido);
        break;
      case "Oso":
        imgPath = "./assets/imgs/Oso.jpg";
        animal = new _TiposDeAnimales.Oso(nombre, edad, imgPath, comentarios, sonido);
        break;
      case "Serpiente":
        imgPath = "./assets/imgs/Serpiente.jpg";
        animal = new _TiposDeAnimales.Serpiente(nombre, edad, imgPath, comentarios, sonido);
        break;
      case "Aguila":
        imgPath = "./assets/imgs/Aguila.png";
        animal = new _TiposDeAnimales.Aguila(nombre, edad, imgPath, comentarios, sonido);
        break;
    }
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 8:
            ...
            objectURL = URL.createObjectURL(blob); // llama a la función agregarAnimalATabla, pasando el objeto animal y la URL del objeto (objectURL) como argumentos. Esta función es responsable de agregar el animal (junto con su imagen) a la tabla en la interfaz de usuario.
  ...
  function agregarAnimalATabla(animal, objectURL) {
    ...
    tabla.innerHTML += "\n        <div class=\"card m-2\" style=\"width: 200px; height: 300px;\" onclick=\"mostrarModal('".concat(animal.nombre, "', '").concat(animal.edad, "', '").concat(objectURL, "', '").concat(animal.comentarios, "')\">\n        <img src=\"").concat(objectURL, "\" class=\"card-img-top my-image\" alt=\"").concat(animal.nombre, "\">\n        <div class=\"card-body\">\n        <h5 class=\"card-title\">").concat(animal.nombre, "</h5>\n        <p class=\"card-text\">").concat(animal.edad, "</p>\n        </div>\n        </div>\n        ");
  }
