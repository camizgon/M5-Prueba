  ...
  document.getElementById("btnRegistrar").addEventListener("click", function () {
    ...
    switch (nombre) {
      case "Leon":
        ...
        animal = new _Leon.Leon(nombre, edad, imgPath, comentarios, sonido);
        // sale del bloque
        break;
      case "Lobo":
        imgPath = "./assets/imgs/Lobo.jpg";
        animal = new _Lobo.Lobo(nombre, edad, imgPath, comentarios, sonido);
        break;
      case "Oso":
        imgPath = "./assets/imgs/Oso.jpg";
        animal = new _Oso.Oso(nombre, edad, imgPath, comentarios, sonido);
        break;
      case "Serpiente":
        imgPath = "./assets/imgs/Serpiente.jpg";
        animal = new _Serpiente.Serpiente(nombre, edad, imgPath, comentarios, sonido);
        break;
      case "Aguila":
        imgPath = "./assets/imgs/Aguila.png";
        animal = new _Aguila.Aguila(nombre, edad, imgPath, comentarios, sonido);
        break;
    }
